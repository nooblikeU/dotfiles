...
-- awful.spawn.with_shell('nvidia-settings --assign CurrentMetaMode="DP-4: nvidia-auto-select +0+0 {ForceCompositionPipeline=On}"')
...
awful.spawn.with_shell("picom --config /home/john/.config/picom/picom.conf &")
